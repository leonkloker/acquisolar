...
import type { PDFDataRangeTransport, PDFDocumentProxy, PDFPageProxy, PasswordResponses } from 'react-pdf/node_modules/pdfjs-dist';
import type { BinaryData, DocumentInitParameters, RefProxy, StructTreeNode, TextContent, TextItem } from 'react-pdf/node_modules/pdfjs-dist/types/src/display/api';
import type { AnnotationLayerParameters } from 'react-pdf/node_modules/pdfjs-dist/types/src/display/annotation_layer';
import type LinkService from 'react-pdf/dist/cjs/LinkService';
