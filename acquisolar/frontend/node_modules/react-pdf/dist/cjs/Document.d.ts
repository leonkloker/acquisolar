...
import type { ClassName, DocumentCallback, ExternalLinkRel, ExternalLinkTarget, File, ImageResourcesPath, NodeOrRenderer, OnDocumentLoadError, OnDocumentLoadProgress, OnDocumentLoadSuccess, OnError, OnItemClickArgs, OnPasswordCallback, Options, PasswordResponse, RenderMode } from 'react-pdf/dist/cjs/shared/types';
...
declare const Document: React.ForwardRefExoticComponent<{
    ...
    options?: {
        ...
        worker?: import("react-pdf/node_modules/pdfjs-dist").PDFWorker | null | undefined;
...
} & EventProps<false | import("react-pdf/node_modules/pdfjs-dist/types/src/display/api").PDFDocumentProxy | undefined> & React.RefAttributes<unknown>>;
